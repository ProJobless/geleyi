...
abstract class Controller {
	...
	/**
	 * The layouts being used by the controller.
	 *
	 * @var string
	 */
	public $layout;
	...
	{
		// If the controller has specified a layouts to be used when rendering
		// views, we will instantiate the layouts instance and set it to the
		// layouts property, replacing the string layouts name.
	...
	public function response($method, $parameters = array())
	{
		...
		// If the controller has specified a layouts view the response
		// returned by the controller method will be bound to that
		// view and the layouts will be considered the response.
	...
	/**
	 * Create the layouts that is assigned to the controller.
	 *
	 * @return View
	 */
